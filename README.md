...
```sh
uv add "my-usermanager @ git+https://github.com/mikolaj92/my-usermanager.git@v0.6.7"
uv add "my-usermanager[myauth] @ git+https://github.com/mikolaj92/my-usermanager.git@v0.6.7"
uv add "my-usermanager[fastapi] @ git+https://github.com/mikolaj92/my-usermanager.git@v0.6.7"
uv add "my-usermanager[fastapi-htmx] @ git+https://github.com/mikolaj92/my-usermanager.git@v0.6.7"
```
...
```sh
uv add "my-usermanager[myauth,fastapi-htmx] @ git+https://github.com/mikolaj92/my-usermanager.git@v0.6.7"
